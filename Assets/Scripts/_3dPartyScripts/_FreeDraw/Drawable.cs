...
namespace FreeDraw
{
	...
	public class Drawable : MonoSingleton<Drawable> //clonx 23.10.2018 было MonoBehaviour
    {
		//public SpriteRenderer holst; //clonx 19.10.2018 Где будем рисовать	
        // PEN COLOUR
		...
		protected Sprite drawable_sprite;	//clonx 15.10.2018 добавил protected
		[HideInInspector]
		public Texture2D drawable_texture; //clonx 15.10.2018 добавил [HideInInspector] public

        protected Vector2 previous_drag_position; //clonx 15.10.2018 добавил protected
        Color[] clean_colours_array;
        Color transparent;
		public Color32[] cur_colors; //clonx 15.10.2018 добавил public
...
// BRUSH TYPES. Implement your own here
        ...
        public void PenBrush(Vector2 world_point)
        {
			...
			Vector2 pixel_pos=new Vector2(v3.x,v3.y)-rectTransform.offsetMin;
			//clonx 30.10.2018 <--
...
//clonx 19.10.2018 -->
		virtual public void SetFillBrush()
		{
		}

		virtual public void ClearDragPosition()
		{
...
//clonx 19.10.2018 <--
        ...
        virtual public void MarkPixelsToColour(Vector2 center_pixel, int pen_thickness, Color color_of_pen) //clonx 20.10.2018 добавил virtual
        {
		...
		virtual public void MarkPixelToChange(int x, int y, Color color) //clonx 20.10.2018 добавил virtual
        {
        ...
        virtual public void ResetCanvas()
        {
